export default {
  ...
  'menu.documents': '文档管理',
  'menu.documents.list': '文档列表',
  'menu.documents.category': '文档分类',
  'menu.carousels': '轮播图管理',
  'menu.carousels.list': '轮播图列表',
  'menu.success-cases': '成功案例管理',
  'menu.success-cases.list': '成功案例列表',
  'menu.experts': '专家团队管理',
  'menu.experts.list': '专家团队列表',
  'menu.articles': '文章管理',
