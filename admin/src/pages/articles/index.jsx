...
class Articles extends Component {
  ...
  fetchMore = () => {
    const { dispatch } = this.props;
    dispatch({
      type: 'contentsArticles/appendFetch',
      payload: {
        count: pageSize,
      },
    });
...
export default connect(({ contentsArticles, loading }) => ({
  contentsArticles,
  loading: loading.models.contentsArticles,
}))(WarpForm);
