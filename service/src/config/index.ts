    ...
    verification: {
        ...
        sms: {
            ...
            templates: {
                ...
                customer: '【2019文化旅游投资】尊敬的嘉宾，您单位申请参加2019江西省第三届文化旅游投资发展促进会已审核通过，恭喜报名成功，同时您已成为我们旅游项目通平台的尊贵会员，账号为您的报名手机号，初始密码为{$var1}，请尽快登录 https://www.lvyoto.com 修改。（此信息只通知联系人）',
                user: '【2019文化旅游投资】尊敬的嘉宾，您单位申请参加2019江西省第三届文化旅游投资发展促进会已审核通过，恭喜报名成功，请准时参会。'
            }
        },
    },
