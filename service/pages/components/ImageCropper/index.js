			...
			<Fragment>
				...
				>
					{/* <Row>
						<Col>宽度：</Col>
						<Col span={12}>
							<Slider min={10} max={2000} onChange={this.onWidthChange} value={width} />
						</Col>
						<Col span={4}>
							<InputNumber
								min={10}
					...
					<Row>
						<Col>高度：</Col>
						<Col span={12}>
							<Slider min={10} max={1000} onChange={this.onHeightChange} value={height} />
						</Col>
						<Col span={4}>
							<InputNumber
								min={10}
					...
					{/* <Row>
						<Col>圆度：</Col>
						<Col span={12}>
							<Slider min={0} max={100} onChange={this.onRadiusChange} value={borderRadius} />
						</Col>
						<Col span={4}>
							<InputNumber
								min={0}
					...
					{/* <Row>
						<Col>缩放：</Col>
						<Col span={12}>
							<Slider min={0.1} max={10} step={0.1} onChange={this.onScaleChange} value={scale} />
						</Col>
						<Col span={4}>
							<InputNumber
								min={0.1}
